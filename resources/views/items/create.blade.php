    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                {{-- Dati delle collezioni con i loro attributi, letti in JS --}}
                @php
                ...
                <div x-data="itemForm({{ json_encode($collectionsData) }}, '{{ old('collection_id', $selectedCollection) }}')">
                                        ...
                                        <div>
                                            ...
                                            <template x-if="attr.type === 'text'">
                                                <input type="text" :name="'attr_' + attr.key"
                                                    ...
                                                    :value="oldValues['attr_' + attr.key] || ''"
                                            ...
                                            <template x-if="attr.type === 'boolean'">
                                                <label class="flex items-center gap-2 cursor-pointer">
                                                    <input type="checkbox" :name="'attr_' + attr.key" value="1"
                                                        :checked="oldValues['attr_' + attr.key] == '1'"
